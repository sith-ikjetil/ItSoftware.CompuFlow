...
namespace ItSoftware.CompuFlow.Generator.Interfaces
{
    public interface IGenerator
    {
        /// <summary>
        /// Generate method. Generates data for the Generator step.
        /// </summary>
        ...
        void Generate(NameValueCollection inputParameters, Hashtable applicationCache, string tempDirectory, string configDirectory, string dataDirectory, string outputDirectory, string retrivalOutputDirectory, IExecutionEngine pIExecutionEngine);
    }
}
