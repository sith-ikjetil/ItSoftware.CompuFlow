...
namespace ItSoftware.CompuFlow.Events.HostRuntime
{
    ...
    /// 
    /// </summary>
    public class RealHandler : RealFlow<HostRuntimeSettings>
    {
        ...
        public override void Execute(string flowManifest, HostRuntimeSettings settings)
        {
            ...
            try
            {
                ...
                if (this.BindingConfig == null)
                {
                    ...
                    this.BindingConfig = new HandlerBindingConfig(xdRetrival);
                ...
                this.BindingConfig.IEventHandlerRef.HandleEvent(manifest, this);
        ...
        /// 
        /// </summary>
        public HandlerBindingConfig BindingConfig { get; private set; }
        /// <summary>
        /// 
        /// </summary>
        ...
        public override bool LogToEvents
        {
            get 
            {
                throw new NotImplementedException();
        ...
        public override IResponseInBrowser ResponseInBrowser
        {
            get
            {
                throw new NotImplementedException();
